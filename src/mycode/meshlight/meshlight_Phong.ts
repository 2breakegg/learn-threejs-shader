...
import shaderVertex from "./meshlight_Phong.vert";
import shaderFragment from "./meshlight_Phong.frag";
...
function init() {
    ...
    // ===============MeshPhongMaterial的球
    let sphere = new THREE.Mesh(new THREE.SphereBufferGeometry(1,20,20),new THREE.MeshPhongMaterial({
        color:0x111111,
        shininess:6,
        specular:0xaaaaaa
    }))
    ...
    uniforms.color = {
        value: new THREE.Color(0x00aa00)
    }
    uniforms.ambient = {
